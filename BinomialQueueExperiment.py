...
if __name__ == '__main__':
    ...
    # titre = "Temps d'execution de la construction d'un tas binomial \n en fonction de la taille de la liste"
    # label = "construction"
    ...
    representation_graphique(list_of_sizes, list_moyenne_temps_union, nom_fichier, xlabel, ylabel, titre, label, False)
